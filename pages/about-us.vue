    ...
    <v-container fluid>
        <v-sheet class="mt-n16" width="100%" color="transparent">
            <video autoplay muted loop playsinline class="landing-video" :poster="require('@/assets/image/loader.webp')">
                <source src="@/assets/image/landing.mp4" type="video/mp4" />
            </video>
        </v-sheet>
        <v-row>
            <v-col cols="12 ml-50" justify="center" lg="11">
    ...
    data() {
        return {
            ...
            faq: [{
                ...
                {
                    question: '6. Are the teachers and attendant aunties qualified enough?',
                ...
                {
                    question: '14. In case of crying babies, are parents allowed to sit with them for first few days?',
...
<style scoped>
.main {
    background-color: rgb(147, 149, 231);
}
