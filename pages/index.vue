  ...
  <v-container fluid class="pa-0">
    <v-row no-gutters>
      <v-sheet class="mt-n16" width="100%" color="transparent">
         <v-img
            :lazy-src="require('@/assets/img/loader.webp')"
            :src="require('@/assets/img/loader.webp')"
            eager
            contain
          ></v-img>
...
<section>
  <about/>
    ...
    <section id="upper-classroom" class="pa-8 text-center">
      ...
      >
      <h1 class="text-h5">
        "Early childhood education is a very important aspect of a child’s life. Human brain is always receptive <span><strong>no matter how it learns</strong></span> ."
      </h1>
    ...
    <section class="mt-4 deep-purple lighten-5" id="Classroom-program">
      ...
      <p class="text--disabled text-center ma-4">Designed to develope a child's seven areas of learning.</p>
